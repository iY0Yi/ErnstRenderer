...
class ERNST_PG_PModifier_IKBoneJoint(PropertyGroup):
    name: bpy.props.StringProperty(default = 'IKBoneJoint')
    ...
    def get_shader_code(self, obj, target_cp_name, id, is_fixed):
        ...
        code = f'''
        // rig joint
        {target_cp_name} = {var_ika_base};

        pIKRig({target_cp_name}, {var_ika}.bon[1]);
        '''
        return code