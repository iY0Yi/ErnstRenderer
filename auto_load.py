# https://github.com/leon196/shiba/blob/master/blender/shiba/auto_load.py
...
def init():
    ...
    print('ordered_classes: ', len(ordered_classes))
...
def get_dependency_from_annotation(value):
    ...
    if 'PointerProperty' in str(value) or 'CollectionProperty' in str(value):
        # cls = inspect.getmembers(value)
