...
5. Install "[Wonder_Mesh_Legacy](https://github.com/Descent098/Wonder_Mesh_Legacy/tree/master)" addon. 
6. Open "tutorial0.blend".
7. Change the viewport shading to "Rendered".
8. Edit GLSLs in the "track" folder. (Save an edited file to the hot reloading) 
9. Enjoy!
